...
model = load_model(f"F:\cvpr/Spring22-23_CVPR/FINAL/Assignment-1/mymodel.h5",compile=False)

with open(f'F:\cvpr/Spring22-23_CVPR/FINAL/Assignment-1/category2label.pkl', 'rb') as cat:
...
face_cascade = cv2.CascadeClassifier(f'F:\cvpr/Spring22-23_CVPR/FINAL/Assignment-1/haarcascade_frontalface_default.xml')
